...
/*IO 4 */    {{ 6, 0}, {36, DIR_OUT}, {-1,-1},          {-1,-1}, {-1,-1}},
/*IO12*/   {{15, 0}, {42,  DIR_IN}, { 43, PULL_DOWN}, {-1,-1}, {-1, -1}},

///*IO 4*/  {{ 6, 0}, {36, DIR_OUT}, {-1,-1},          {-1,-1}, {-1,-1}},
///*IO 6*/   {{ 1, 0}, {20,  DIR_IN}, { 21, PULL_DOWN}, {68, 0}, {-1, -1}},
};
char* A_pin_str[2][5] = { 
...
char B_pins[2][5][2] = { 
          //Linux   Level             Pull            Mux0      Mux1
///*IO12*/   {{15, 0}, {42,  DIR_OUT}, { -1, -1}, {-1,-1}, {-1, -1}},
///*IO10*/   {{10, 0}, {26, DIR_IN}, {27,PULL_DOWN}, {74, 0}, {-1,-1}},

//old
/*IO10*/   {{10, 0}, {26, DIR_OUT}, {-1,-1},          {74, 0}, {-1,-1}},
/*IO 6*/   {{ 1, 0}, {20,  DIR_IN}, { 21, PULL_DOWN}, {68, 0}, {-1, -1}},
};
char* B_pin_str[2][5] = { 
